...
// AARON
// source: https://groups.google.com/forum/#!topic/openkinect/meoQYtdIUY0
...
class MyFreenectDevice : public Freenect::FreenectDevice {
	public:
		MyFreenectDevice(freenect_context *_ctx, int eindex) : Freenect::FreenectDevice(_ctx, _index), m_buffer_depth(FREENECT_VIDEO_RGB_SIZE),m_buffer_video(FREENECT_VIDEO_RGB_SIZE), m_gamma(2048), m_new_rgb_frame(false), m_new_depth_frame(false) {
...
int main(int argc, char **argv) {
   ...
   printf("Creating Kinect Device\n");
	device = &freenect.createDevice<MyFreenectDevice>(0);

	//Start Kinect Device
   printf("Starting Kinect Device\n");
